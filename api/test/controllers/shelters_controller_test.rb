...
class SheltersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelter" do
    assert_difference('Shelter.count') do
      post shelters_url, params: { shelter: { available: @shelter.available, lat: @shelter.lat, lng: @shelter.lng } }, as: :json
    end
  ...
  test "should update shelter" do
    patch shelter_url(@shelter), params: { shelter: { available: @shelter.available, lat: @shelter.lat, lng: @shelter.lng } }, as: :json
    assert_response 200
  end
